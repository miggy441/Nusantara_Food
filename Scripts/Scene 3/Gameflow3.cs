...
{
    public static int[] orderValue = { 21000, 31000, 41000 };
    ...
    void Update()
    {
        ...
        plateSelector.transform.position = new Vector3(plateXpos, 0.26f, 0);
    }
